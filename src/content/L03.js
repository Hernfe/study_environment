...
export default {
  ...
  recap: {
    terms: [
      ...
      { term: 'Chemical synapse, presynaptic', definition: 'Terminal with vesicles (50 nm), secretory granules (100 nm, peptides), mitochondria and active zones.' },
      { term: 'Chemical synapse, postsynaptic', definition: 'Cleft 20 to 50 nm, then the postsynaptic density holding the receptors.' },
      { term: 'Gap junction', definition: '6 connexins = connexon; 2 connexons = channel; many channels = gap junction.' },
      { term: 'Gap junction dimensions', definition: 'Membranes 3.5 nm apart, pore 1 to 2 nm. Ions and small molecules pass both ways.' },
      { term: 'Electrical synapse', definition: 'Direct current, no delay, bidirectional, PSP about 1 mV; fail-safe if large. Synchronizes oscillations (inferior olive, connexin36).' },
      ...
      { term: 'Release trigger', definition: 'The spike opens voltage-gated Ca2+ channels at the active zone; a Ca2+ microdomain forms beside docked vesicles.' },
      { term: 'Fusion machinery', definition: 'Synaptotagmin senses Ca2+; SNAREs (v on the vesicle, t on the target) fuse it; a fusion pore opens.' },
      { term: 'Release speed and recycling', definition: 'Exocytosis within 0.2 ms (60 us in mammals); endocytosis recycles. Botulinum toxin cuts SNAREs.' },
      { term: 'Quantum', definition: 'Contents of one vesicle. CNS synapse about 1 per spike (tenths of a mV); NMJ about 200 (40 mV).' },
      { term: 'Ionotropic receptor', definition: 'Transmitter-gated channel of 4 or 5 subunits, opens in microseconds. Na+: EPSP (ACh, glutamate). Cl-: IPSP (GABA, glycine).' },
      { term: 'Metabotropic receptor', definition: 'G-protein-coupled, 7 helices. Effector: a G-protein-gated channel (shortcut, 30 to 100 ms) or a second-messenger enzyme.' },
      ...
      { term: 'Reversal potential', definition: 'Vm where the channel current changes direction, read off the I-V plot. Mixed Na+/K+ channel: about 0 mV.' },
      { term: 'Excitatory or inhibitory', definition: 'Excitatory if E_rev lies above threshold, inhibitory if it lies below.' },
      ...
      { term: 'Summation', definition: 'Spatial: different synapses at the same time. Temporal: the same synapse within 1 to 15 ms.' },
      ...
      { term: 'Shunting inhibition', definition: 'Cl- channels at ECl near rest lower membrane resistance; Cl- entry opposes the depolarization, so the somatic EPSP shrinks.' },
      ...
      { term: 'AMPA and kainate receptors', definition: 'Glutamate-gated channels passing Na+ and K+; net inward current at rest, so a fast EPSP. Named after agonists.' },
      { term: 'NMDA receptor', definition: 'Passes Na+, K+ and Ca2+. Mg2+ blocks the pore until depolarization removes it. Slow; coincidence detector.' },
      ...
      { term: 'NE beta cascade', definition: 'NE binds the beta receptor and Gs; adenylyl cyclase; ATP to cAMP; protein kinase A; a K+ channel closes.' },
