...
export default {
  ...
  recap: {
    terms: [
      ...
      { term: 'Protein structure', definition: '20 amino acids joined by peptide bonds. Primary sequence, secondary alpha helix, tertiary 3D fold, quaternary subunits.' },
      { term: 'Membrane protein', definition: 'Hydrophobic parts sit in the lipid, hydrophilic parts face the water or line the pore.' },
      ...
      { term: 'Equilibrium potential E_ion', definition: 'Vm where diffusion and electrical force on one ion balance: no net current. Exists even with the channels shut.' },
      ...
      { term: 'Ion table: K+ and Na+ (37 C)', definition: 'K+ 5 out / 100 in, EK -80 mV. Na+ 150 / 15, ENa +62 mV.' },
      { term: 'Ion table: Ca2+ and Cl- (37 C)', definition: 'Ca2+ 2 / 0.0002, ECa +123 mV. Cl- 150 / 13, ECl -65 mV. Concentrations in mM.' },
      { term: 'Sodium-potassium pump', definition: 'ATP-driven: 3 Na+ out, 2 K+ in per cycle. Up to 70 percent of brain ATP.' },
      { term: 'What the pump does not do', definition: 'It maintains the gradients, with only a small direct effect on Vm. It does not make the spike.' },
      { term: 'Calcium pump', definition: 'Plus binding proteins and organelles keep cytosolic Ca2+ at 0.0002 mM.' },
      { term: 'Resting permeability', definition: 'PK about 40 times PNa, so Vm sits near EK. The Na+ leak lifts it to -65 mV.' },
      { term: 'Sensitivity to [K+]o', definition: 'Raising [K+]o from 5 to 50 mM moves Vm from -65 to -17 mV.' },
      { term: 'GHK equation', definition: 'Vm from concentrations and relative permeabilities of all permeant ions, anions flipped. Raise a P, Vm follows that E.' },
      ...
      { term: 'Action potential', definition: 'About 2 ms: rest, threshold, rising phase, overshoot above 0 mV, falling phase, undershoot, back to rest.' },
      { term: 'Recording', definition: 'Intracellular: Vm, about 100 mV spike. Extracellular: biphasic, tens of uV. Stimulate and record at the hillock.' },
      ...
      { term: 'Absolute refractory period', definition: 'About 1 ms: Na+ channels inactivated, so no stimulus can fire a spike. Caps firing near 1000 Hz.' },
      { term: 'Relative refractory period', definition: 'Several ms: some Na+ channels still recovering and gK raised, so a stronger stimulus is needed.' },
      { term: 'Conductance sequence', definition: 'Rest: gK >> gNa. Rising: gNa >> gK. Falling: gK >> gNa. Vm follows whichever conductance dominates.' },
      { term: 'Conductance timing', definition: 'gNa rises fast and falls fast; gK is delayed about 1 ms and lasts longer.' },
      { term: 'Voltage clamp', definition: 'Cole. Holds Vm and measures the membrane current, so the conductance changes can be deduced.' },
      { term: 'Hodgkin and Huxley', definition: 'Squid axon, about 1950: early inward Na+ current, delayed outward K+ current. Model 1952, Nobel 1963.' },
      { term: 'TTX', definition: 'Tetrodotoxin, puffer fish. Blocks the Na+ pore from outside; abolishes Na+-dependent spikes.' },
      { term: 'Voltage-gated Na+ channel', definition: 'One polypeptide, 4 domains of 6 helices S1-S6. S4 is the voltage sensor; the gate opens near -40 mV.' },
      { term: 'Selectivity filter', definition: 'Pore loops between S5 and S6. Na+ 12 times over K+: partly hydrated Na+ (0.5 nm) fits.' },
      ...
      { term: 'Patch clamp', definition: 'Sakmann and Neher, Nobel 1991. Pipette 1-5 um, gigaohm seal, one or a few channels.' },
      { term: 'Single-channel record', definition: 'Step amplitude = single-channel current (conductance = I / driving force); duration = open time; repeats give open probability.' },
      { term: 'Na+ channel stages', definition: '1 closed; 2 open on depolarization, up to 1 ms; 3 inactivated, ball plugs pore; 4 deinactivated on repolarization.' },
      { term: 'Population current', definition: 'Single-channel current x number of channels x open probability.' },
      { term: 'Spike-initiation zone', definition: 'Highest Na+ channel density, lowest threshold. Pyramidal cell: axon hillock and initial segment. Sensory neuron: the nerve ending.' },
      { term: 'Conduction', definition: 'Na+ entry; local current takes the membrane ahead to threshold; regenerated patch by patch, like a fuse.' },
      { term: 'Direction of conduction', definition: 'One way, because the membrane behind is refractory. Orthodromic soma to terminal, antidromic backward. Mid-axon stimulus: both ways.' },
      { term: 'Velocity', definition: 'Typically 10 m/s, so a 2 ms spike occupies 2 cm of axon.' },
      { term: 'What makes it faster', definition: 'Bigger diameter (less internal resistance) and myelin (less leak across the membrane).' },
      { term: 'Myelin and nodes', definition: 'Glial wrap: Schwann cells in PNS, oligodendroglia in CNS. Nodes of Ranvier 0.2-2 mm apart, Na+ channels concentrated there.' },
      { term: 'Saltatory conduction', definition: 'The spike is regenerated only at the nodes and jumps between them. Demyelination (MS, Guillain-Barre) slows or blocks it.' },
    ],
    equations: [
      {
        name: 'Ionic current',
